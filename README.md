# Внимание! Программа устарела! Используйте новую версию https://github.com/REDNBLACK/J-Kinopoisk2IMDB, по этой ссылке есть подробный мануал. Пожалуйста, не используйте эту (старую) версию.
```
